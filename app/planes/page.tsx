          ...
          {PLANS.map((plan) => (
            ...
            >
              ...
              <button
                ...
                disabled={purchasing}
                className="w-full py-3 rounded-xl font-clash font-bold text-sm transition bg-white text-black hover:bg-black hover:text-white disabled:opacity-50 flex items-center justify-center gap-2 cursor-pointer hover:scale-110"
              >
                {purchasing && (
