...
export function PoliticaPrivacidadPage() {
  return (
    <LegalPageShell
      ...
      description="Conoce cómo Weincard recopila, usa y protege tu información personal."
    ...
    >
          ...
          {/* Marco Jurídico */}
          <section>
            <h2 className="mb4">1. MARCO JURÍDICO</h2>
            <p className="mb4">
            ...
            <div className="box">
              <h3 className="strong mb3">Constitución Política</h3>
              <p className="sm">
            ...
            <div className="box mt4">
              <h3 className="strong mb3">Ley Estatutaria 1581 de 2012</h3>
              <p className="sm">
          ...
          {/* Definiciones */}
          <section>
            <h2 className="mb4">4. DEFINICIONES LEGALES</h2>
            <p className="mb4">
          ...
          <section>
            ...
            <div className="box mt4">
              ...
              <ul className="stack2 mt3 ml4 sm">
          ...
          {/* Eliminación de cuenta y conservación */}
          <section>
            <h2 className="mb4">
              12. ELIMINACIÓN DE CUENTA Y CONSERVACIÓN DE DATOS
            </h2>
            <p className="mb4">
          ...
          <section>
            <h2 className="mb4">
              13. VIGENCIA DE LA POLÍTICA DE TRATAMIENTO DE LA INFORMACIÓN PERSONAL
            </h2>
            <p>
          ...
          {/* Modificaciones */}
          <section>
            <h2 className="mb4">14. MODIFICACIÓN DE LAS POLÍTICAS</h2>
            <p>
