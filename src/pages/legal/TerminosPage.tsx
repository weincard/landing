...
export function TerminosPage() {
  return (
    <LegalPageShell
      ...
      description="Lee los términos y condiciones del servicio Weincard."
      path="/terminos-y-condiciones"
      updated="Septiembre 19, 2025"
    >
          {/* SECCIÓN PRIMERA */}
          <section>
            <h2 className="mb4 upper">
              Sección Primera - Aspectos Preliminares
            </h2>

            <div className="stack6">
              <div>
                <h3 className="strong mb2">1. ADVERTENCIA SOBRE OBLIGATORIEDAD</h3>
                <p>
              ...
              <div>
                <h3 className="strong mb2">2. ESTRUCTURA DE LOS TyC</h3>
                <p className="mb3">
          ...
          <section>
            ...
            <div className="stack6">
              <div>
                <h3 className="strong mb2">3. DEFINICIONES</h3>
                <p className="mb4">
              ...
              <div>
                <h3 className="strong mb2">4. ACEPTACIÓN</h3>
                <p>
              ...
              <div>
                <h3 className="strong mb2">5. DESCRIPCIÓN DE LA PLATAFORMA</h3>
                <p>
              ...
              <div>
                <h3 className="strong mb2">6. ALCANCE DE LOS SERVICIOS</h3>
                <p>
              ...
              <div>
                <h3 className="strong mb2">7. ACCESO A WEINCARD.COM</h3>
                <p className="mb3">
              ...
              <div>
                <h3 className="strong mb2">8. CREACIÓN DE CUENTA DE USUARIO</h3>
                <p className="mb3">
                ...
                <ul className="plain stack3 ml4">
                  ...
                  <li>
                    ...
                    <Link to="/politica-de-privacidad" className="link">
                      https://www.weincard.com/politica-de-privacidad
                    </Link>
                  </li>
                  <li>
                    ...
                    <ul className="ul mt2 ml6 stack1">
              ...
              <div>
                <h3 className="strong mb2">9. TRATAMIENTO DE DATOS PERSONALES</h3>
                <p>
              ...
              <div>
                <h3 className="strong mb2">11. PROPIEDAD INTELECTUAL</h3>
                <p>
              ...
              <div>
                <h3 className="strong mb2">13. CONDUCTAS PROHIBIDAS</h3>
                <p className="mb3">
          ...
          <section>
            ...
            <div className="stack6">
              <div>
                <h3 className="strong mb2">20. MEMBRESÍA</h3>
                <p>
              ...
              <div>
                <h3 className="strong mb2">21. OBLIGACIONES DEL USUARIO MIEMBRO</h3>
                <p className="mb3">El Usuario Miembro se obliga a:</p>
                <ul className="ul stack2 ml4">
              ...
              <div>
                <h3 className="strong mb2">22. FORMAS DE PAGO</h3>
                <p>
              ...
              <div>
                <h3 className="strong mb2">23. RENOVACIÓN Y CANCELACIÓN</h3>
                <p>
          ...
          <section>
            ...
            <div className="stack6">
              <div>
                <h3 className="strong mb2">25. LIMITACIONES DE RESPONSABILIDAD</h3>
                <p>
                ...
                <ul className="ul stack2 ml4 mt3">
              ...
              <div>
                <h3 className="strong mb2">27. PROTECCIÓN DE DATOS PERSONALES</h3>
                <p>
              ...
              <div>
                <h3 className="strong mb2">29. LEY APLICABLE Y JURISDICCIÓN</h3>
                <p>
              ...
              <div>
                <h3 className="strong mb2">30. MODIFICACIONES</h3>
                <p>
              ...
              <div>
                <h3 className="strong mb2">31. NULIDAD PARCIAL</h3>
                <p>
              ...
              <div>
                <h3 className="strong mb2">32. CESIÓN</h3>
                <p>
          ...
          <section className="box mt8">
            <h3 className="strong mb3">Información de Contacto</h3>
